...
private void MostrarCliente(String valor) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(uno2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, 100, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 580, 310));
        ...
        jPanel1.add(uno1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 470, 100, 40));

        uno3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_cancelar.png"))); // NOI18N
        uno3.setBorder(null);
        ...
        jPanel1.add(uno3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 470, 120, 40));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 640, 540));
        ...
        jPanel2.add(uno, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, 70, 40));

        jLabel5.setFont(new java.awt.Font("Decker", 1, 26)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Añadir cliente");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 10, 220, 50));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -3, 640, 70));
